\documentclass[version=last]{scrlttr2} \usepackage[ngerman]{babel} \begin{document} \begin{letter}[fontsize=14pt]{%
...
\encl{Auszug aus der Satzung, in dem dieMitgliederversammlungen geregelt sind}
